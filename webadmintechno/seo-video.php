...
<div class="panel-body">
    <form  action="dbfile.php"  method="post" enctype="multipart/form-data">
		  ...
		  <div class="row">
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="videotitle" id="videotitle" rows="6" class="form-control" placeholder="Title"><?php echo $videotitle;?></textarea>
				   <label>Title </label>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="videodesc" id="videodesc" rows="6" class="form-control" placeholder="Description"><?php echo $videodesc;?></textarea>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="videokeyword" id="videokeyword" rows="6" class="form-control" placeholder="Keywords"><?php echo $videokeyword;?></textarea>
		...
		<div class="row">
		  ...
		  <div class="col-md-1">	
			 <br>
			 <input type="submit" name="editvideoseo" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
		  </div>
	   </div>
    </form>
</div>
