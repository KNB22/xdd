...
<div class="panel-heading">
   <h6 class="panel-title">Index Page</h6>
...
<div class="panel-body">
    <form  action="dbfile.php"  method="post" enctype="multipart/form-data">
		  ...
		  <div class="row">
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="indextitle" id="indextitle" rows="4" maxlength="70" class="form-control" placeholder="Title"><?php echo $indextitle;?></textarea>
				   <label>Title </label>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="indexdesc" id="indexdesc" rows="6" class="form-control" placeholder="Description"><?php echo $indexdesc;?></textarea>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="indexkeyword" id="indexkeyword" rows="6" class="form-control" placeholder="Keywords"><?php echo $indexkeyword;?></textarea>	
		...
		<div class="row">
		  ...
		  <div class="col-md-1">	
			 <br>
			 <input type="submit" name="editindexseo" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
		  </div>
	   </div>
    </form>
</div>
