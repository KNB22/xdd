...
<div class="page-header page-header-default">
   <div class="breadcrumb-line">
      ...
      <ul class="breadcrumb">
         ...
         <li><a href="all-service.php">All Sub Service/Product</a></li>
         <li class="">Edit Sub Service/Product</li>
      </ul>
   </div>
</div>
<!-- /page header -->
...
<div class="panel-heading">
   <h6 class="panel-title">Edit Sub Service/Product</h6>
...
<div class="panel-body">
   ...
   <fieldset>
      <div class="row">
	      <div class="col-md-6">
			 <div class="form-group">
				<select name="serviceid" id="serviceid" data-placeholder="Select Service" class="select">
					<option>Select Sub Service/Product</option>
					<?php
						include("database.php");
	     ...
	     <div class="col-md-6">
            <div class="form-group">
               <input type="text" name="subservicename" id="subservicename" value="<?php echo $subservicename;?>" class="form-control " placeholder="Sub Service/Product Name">
					 ...
					 ?>
						<div class="col-md-4" id="divphoto1">
						  <div id="container">
							  ...
							  <p id="text">
								<i class="fa fa-trash" id="icon" onClick="delphoto1('<?php echo $subserviceid?>','<?php echo $fpic1?>')"></i>
							  </p>
						   </div>
						</div>  
					<?php
		...
		<div class="col-md-6">
			<div class="form-group">
			   <input type="text" name="serviceimgtitle" id="serviceimgtitle" value="<?php echo $serviceimgtitle;?>" class="form-control" placeholder="Other Image Title">
   ...
   <div class="row">
      ...
      <div class="col-md-1">	
         <br>
         <input type="submit" name="editsubservice" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
      </div>
   </div>
   </form>
</div>
