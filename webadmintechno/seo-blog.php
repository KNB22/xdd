...
<div class="panel-body">
    <form  action="dbfile.php"  method="post" enctype="multipart/form-data">
		  ...
		  <div class="row">
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="blogtitle" id="blogtitle" rows="6" class="form-control" placeholder="Title"><?php echo $blogtitle;?></textarea>
				   <label>Title </label>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="blogdesc" id="blogdesc" rows="6" class="form-control" placeholder="Description"><?php echo $blogdesc;?></textarea>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="blogkeyword" id="blogkeyword" rows="6" class="form-control" placeholder="Keywords"><?php echo $blogkeyword;?></textarea>
		...
		<div class="row">
		  ...
		  <div class="col-md-1">	
			 <br>
			 <input type="submit" name="editblogseo" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
		  </div>
	   </div>
    </form>
</div>
