...
<div class="panel-body">
    <form  action="dbfile.php"  method="post" enctype="multipart/form-data">
		  ...
		  <div class="row">
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="abouttitle" id="abouttitle" rows="6" class="form-control" placeholder="Title"><?php echo $abouttitle;?></textarea>
				   <label>Title  </label>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="aboutdesc" id="aboutdesc" rows="6" class="form-control" placeholder="Description"><?php echo $aboutdesc;?></textarea>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="aboutkeyword" id="aboutkeyword" rows="6" class="form-control" placeholder="Keywords"><?php echo $aboutkeyword;?></textarea>
		...
		<div class="row">
		  ...
		  <div class="col-md-1">	
			 <br>
			 <input type="submit" name="editaboutseo" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
		  </div>
	   </div>
    </form>
</div>
