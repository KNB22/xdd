...
<div class="panel-heading">
   <h6 class="panel-title">Gallery</h6>
...
<div class="panel-body">
    <form  action="dbfile.php"  method="post" enctype="multipart/form-data">
		  ...
		  <div class="row">
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="gallerytitle" id="gallerytitle" rows="6" class="form-control" placeholder="Title"><?php echo $gallerytitle;?></textarea>
				   <label>Title </label>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="gallerydesc" id="gallerydesc" rows="6" class="form-control" placeholder="Description"><?php echo $gallerydesc;?></textarea>
			 ...
			 <div class="col-md-12">
				<div class="form-group">
				   <textarea type="text" name="gallerykeyword" id="gallerykeyword" rows="6" class="form-control" placeholder="Keywords"><?php echo $gallerykeyword;?></textarea>
		...
		<div class="row">
		  ...
		  <div class="col-md-1">	
			 <br>
			 <input type="submit" name="editgalleryseo" value="Edit" class="btn btn-primary active" style="width:145%;" title="Submit Form">
		  </div>
	   </div>
    </form>
</div>
