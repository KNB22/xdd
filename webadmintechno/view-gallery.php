...
<div class="panel panel-white">
   <div class="panel-heading">
      <h6 class="panel-title">View Gallery</h6>
   ...
   <form class="" action="dbfile.php" method="post" enctype="multipart/form-data">	
	    ...
	    <div class="panel-body">
		 ...
		 <div class="col-md-6">
				<div class="form-group">
				   <input type="text" name="galttag" id="galttag" value="<?php echo $galttag?>" class="form-control" placeholder="Image Alt Tag" readonly>
				   <label>Image Alt Tag </label>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
				   <input type="text" name="gtitle" id="gtitle" value="<?php echo $gtitle?>" class="form-control" placeholder="Image Title" readonly>
				   <label>Image Title </label>
				</div>
			</div> 
			<div class="col-md-12">
				<div class="form-group">
				   <input type="text" name="gdescription" id="gdescription" value="<?php echo $gdescription?>" class="form-control" placeholder="Image Description" readonly>
