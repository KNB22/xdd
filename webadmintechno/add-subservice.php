...
<div class="page-header page-header-default">
   <div class="breadcrumb-line">
      ...
      <ul class="breadcrumb">
         ...
         <li class="">Add Sub Service/Product</li>
      </ul>
   </div>
</div>
<!-- /page header -->
...
<div class="panel-heading">
   <h6 class="panel-title">Add Sub Service/Product</h6>
...
<div class="panel-body">
   ...
   <fieldset>
      <div class="row">
	     ...
	     <div class="col-md-6">
            <div class="form-group">
               <input type="text" name="subservicename" id="subservicename" value="" class="form-control " placeholder="Sub Service/Product Name">
		...
		<div class="col-md-6">
		 ...
		 <div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
				   <input type="text" name="serviceimgtitle" id="serviceimgtitle" class="form-control" placeholder="Other Image Title">
   ...
   <div class="row">
      ...
      <div class="col-md-1">	
         <br>
         <input type="submit" name="addsubservice" value="Add" class="btn btn-primary active" style="width:145%;" title="Submit Form">
      </div>
   </div>
   </form>
</div>
