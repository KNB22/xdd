...
<div class="page-header page-header-default">
   <div class="breadcrumb-line">
      ...
      <ul class="breadcrumb">
         ...
         <li class="">View Sub Service/Product1</li>
      </ul>
   </div>
</div>
<!-- /page header -->
...
<div class="panel-heading">
   <h6 class="panel-title">View Sub Service/Product1</h6>
      ...
      <div class="row">
	      <div class="col-md-6">
			 <div class="form-group">
				...
				<label style="color: green;">Select Service/Product: <span class="text-danger">*</span></label>
			 </div>
		 </div>
	     <div class="col-md-6">
            <div class="form-group">
			    <?php
						$query_dis = "select subserviceid,subservicename from subservices where serviceid = '$fserviceid' AND subserviceid='$fsubserviceid'";
						$result_dis = mysqli_query($mysqli,$query_dis);  
	
						if($row11 = mysqli_fetch_array($result_dis))
						{
							extract($row11);				
						}	
				?>
		 ...
		 <div class="col-md-6">
            <div class="form-group">
               <input type="text" name="subservicename" id="subservicename" value="<?php echo $prosubservicename;?>" class="form-control " placeholder="Subservice Name" readonly>
               <label>Sub Service/Product1 Name: </label>
            </div>
         </div>
		<div class="row">
			<div class="col-md-12">
			   <div class="col-md-12"><h4 class="text-semibold">Service/Product1 Photo:</h4></div>
